      ...
      <div className="max-w-md mx-auto">
        ...
        <header className="text-center mb-6 pt-6">
          ...
          <div className="flex justify-center gap-4">
            <a href="https://www.facebook.com/profile.php?id=61589520449347" target="_blank" rel="noopener noreferrer" className="p-2.5 bg-white rounded-full shadow-sm text-blue-600 hover:bg-blue-50 transition-colors border border-gray-200">
